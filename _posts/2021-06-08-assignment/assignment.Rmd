...
Parallel Coordinates Graph (Location, Date, Timestamp, Price, Name)
Gantt Chart
...
spots$concat_cc_spots <- paste(spots$date,spots$Location,spots$hour) #Create a separate column of unique values using concatenated values in the distilled GPS data
