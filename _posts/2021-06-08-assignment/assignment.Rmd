...
## 2.	Literature Review
A cursory look at the dataset reveals the following types of data:

| Data            | Type        | Description                                         |
| :---:           |    :----:   |         :---                                        |
| Credit Card     | Aspatial    | Credit card txns by timestamp, location and amt     |
| Loyalty         | Aspatial    | Loyalty card txns by date, location and amt         |    
| Car Assignment  | Aspatial    | Car assignment ID with individuals' name and role   |
| MC2.jpg         | Aspatial    | Abila's map in jpeg format                          |
| MC2.tif         | Geospatial  | Abila's map in a geotiff format                     |
| GPS             | Geospatial  | GPS points (latlong) by car ID and timestamp        |
| Abila           | Geospatial  | Abila's road network                                |
| Kronos Island   | Geospatial  | Polygon showing Kronos Island's admin boundary      |

The following two considerations need to be addressed:
...
### 2.2 Visualising large GPS Data
