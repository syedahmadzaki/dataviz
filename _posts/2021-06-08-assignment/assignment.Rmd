...
While it makes sense to convert our GPS points into spatial lines, using the furnished map pic as a basemap is less than ideal. As shown below, it's unclear whether the gps path coincides with the location icons shown on the map. These icons are too large, and does not reflect whether these gps points drove past or stopped at these points.
...
1) Explore presence of two or more individuals at the same location at the same hour for extended periods
