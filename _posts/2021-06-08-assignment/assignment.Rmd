...
#### 5.1.2 What type of location is Hippokampos? It seems near to Gastech

#### 5.1.3 Kronos Mart's Txns Are One Day Apart
...
1a. Using only the credit card data, we'll examine the locations by date using a calendar heatmap.
