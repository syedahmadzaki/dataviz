...
![Figure 4: Sktech of Eventual Visualisation](img/sketch.png)
...
Steps <- c("Using Microsoft Excel file, open the raw data (outputFile.xlsx).",
           ...
           "Uncheck the six countries (Hong Kong, Mainland China, Japan, Malaysia, Taiwan and US) from the Country filter and delete the rows. Then remove filter to populate the table with only the six countries. ",
           "Select the periods within 2021 from the Period filter and delete the rows. Save this file as \"Consol\". This file will then be used for the visualisation on Tableau Desktop.")
...
Steps <- c("Open Tableau Desktop. Then connect to MS Excel and import the earlier Consol file.",
           ...
           "To know the lowest level between Export and Import for each month, a calculated field will need to be created. Select Trade Amt from the left Data bar, and create a Calculated Field",
...
Steps <- c("Create a new Dashboard. On the top left, select Default Dashboard, and then select Automatic as its size",
           ...
           "To perfectly align the header, select the text and then the layout column. Follow the position and size dimensions as shown in the picture. Do note that your width might differ from the picture, given your differing screen resolution.",
           ...
           "As per before, to perfectly align the sub-header, select the text and then the layout column. Follow the position and size dimensions as shown in the picture.",
           "Next drag the newly created Viz sheet into the dashboard and remove its legend.",
           "To nicely align the Viz sheet, follow the position and size dimensions as shown in the picture.",
           ...
           "Rename your dashbaord as Viz1 and then save this dashboard to Tableau Public.")
Screenshots <- c("img/47.png",
                 "img/48.png",
                 "img/49.png",
                 "img/50.png",
                 "img/51.png",
